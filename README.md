...
To submit lab exercise solutions as part of course evaluation

To demonstrate correct understanding of algorithmic concepts

To present working, testable implementations using Google Colab

To maintain a clear and organized record of lab work

📂 Repository Structure

Each lab file corresponds to a specific lab session or assignment

Questions are solved in the same order as provided

Solutions are written in separate cells where required

Outputs are included to verify correctness
...
Standard Python libraries only (as permitted)

No external or unauthorized libraries have been used.

📝 Academic Integrity Statement

All solutions have been implemented by the student

Code is written for learning and evaluation purposes

No plagiarism or unauthorized sources were used

Logic and structure follow the course syllabus and lab instructions
...
Inputs and outputs are clearly visible

Proper formatting is maintained for readability

📅 Submission Information

Course: Algorithms and Problem Solving
